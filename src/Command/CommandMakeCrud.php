 ...
 */
final class CommandMakeCrud extends AbstractMaker
{
    ...
    {
        $command
            ->addArgument('entity-class', InputArgument::OPTIONAL, sprintf('Le nom de class de l\'entité pour créer le CRUD (e.g. <fg=yellow>%s</>)', Str::asClassName(Str::getRandomTerm())))
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        if ($this->numberviews == true) {   // 2 vues
            foreach ($templates as $template => $variables) {
                $generator->generateTemplate(
                    ...
                    __DIR__.'/../Resources/skeleton/crud/templates/1/'.$template.'.tpl.php',
                    $variables
                );
            }
        } else {    // 3 vues
            foreach ($templates as $template => $variables) {
                $generator->generateTemplate(
                    $templatesPath.'/'.$template.'.html.twig',
                    __DIR__.'/../Resources/skeleton/crud/templates/2/'.$template.'.tpl.php',
                    $variables
                );
            }
        }
        ...
        if ($this->generateTests) {
            ...
            $generator->generateFile(
                ...
                $usesEntityManager ? __DIR__.'/../Resources/skeleton/crud/test/Test.EntityManager.tpl.php' : __DIR__.'/../Resources/skeleton/crud/test/Test.tpl.php',
                [
                    'use_statements' => $useStatements,
